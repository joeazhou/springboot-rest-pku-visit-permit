...
public final class PKUvisitOrder {
    public final boolean success;
    public final long results;
    public final Row rows[];

    @JsonCreator
    public PKUvisitOrder(@JsonProperty("success") boolean success, @JsonProperty("results") long results, @JsonProperty("rows") Row[] rows){
